---
name: tapestry
description: Content extraction and actionable implementation planning from any source. Use this skill when tapestry, content extraction, action planning, YouTube to implementation, PDF analysis, research to roadmap, learning automation. Use this skill when transcript analysis, knowledge extraction, web scraping, PDF extraction, video insights, learning path, feature planning, implementation roadmap.
---
