...
name: claude-code
description: Claude Code CLI configuration, MCP server setup, and multi-agent orchestration (OMC) automation. Use when Claude Code CLI, settings.json, CLAUDE.md, MCP server setup, model routing, subagent spawning.
---
