...
description: Search engine architecture and full-text search implementation. Use this skill when search, full-text search, Algolia, Meilisearch, Typesense, fuzzy search, autocomplete, search ranking, faceted search. Use this skill when search indexing, typo tolerance, relevance tuning, search UX, product discovery, Elasticsearch, PostgreSQL FTS, search performance.
---
