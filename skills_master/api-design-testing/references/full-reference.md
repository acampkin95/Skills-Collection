...
description: REST API design, type-safe validation, OpenAPI specs, and contract testing with Hono, Zod, and MSW. Use this skill when OpenAPI 3.1, Zod validation, Hono routing, MSW mocking, Pact contract testing, RFC 7807 errors, API rate limiting, CORS configuration, API versioning, REST conventions, request validation, contract testing, OpenAPI spec generation. Use this skill when designing REST endpoints, building type-safe APIs, generating API documentation, setting up API mocking, writing contract tests, implementing error handling standards, configuring pagination, and establishing API versioning strategies.
---
