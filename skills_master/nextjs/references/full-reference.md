---
name: nextjs
description: Next.js 16 full-stack development with App Router, React 19, and Turbopack. Use when app router, Server Components, Server Actions, Partial Prerendering, PPR, incremental static regeneration, ISR, dynamic routes, metadata API, hydration issues.
---
