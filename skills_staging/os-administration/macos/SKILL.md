...
name: macos
description: macOS automation, AppleScript, Homebrew, Mac shortcuts, launchd, Keychain, system administration for developers. Use when macOS, macOS automation, AppleScript, osascript, Homebrew, brew install, Mac shortcuts, defaults write, launchd plist.
---
