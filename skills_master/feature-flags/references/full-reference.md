---
name: feature-flags
description: Feature flag systems for gradual rollouts, A/B testing, and operational control with LaunchDarkly/Statsig/GrowthBook. Use this skill when feature flag, release toggle, A/B test, experiment flag, kill switch, feature gate, LaunchDarkly, Statsig, GrowthBook, gradual rollout, flag targeting rules, permission gate, operational switch, flag cleanup. Use this skill when implementing gradual feature rollouts, configuring A/B tests and experiments, building kill switches and circuit breakers, managing flag lifecycle and cleanup, setting up targeting rules and audience segmentation, implementing permission gates for beta features, integrating with feature flag platforms, and managing operational control switches for production systems.
---
