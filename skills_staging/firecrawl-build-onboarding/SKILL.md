...
description: Set up Firecrawl credentials, SDKs, and project config for app integration.
license: ISC
metadata:
  author: firecrawl
  version: "0.1.0"
...
- [firecrawl-build](../firecrawl-build/SKILL.md) — endpoint-selection router for app integration
