...
name: biome-linting
description: Biome v2.4.16 — Rust-based all-in-one linter, formatter, and import sorter for JavaScript/TypeScript. Use when biome.json, lint config, format on save, biome CI, JS/TS lint.
---

# Biome v2.4.16 — Unified Linting & Formatting
