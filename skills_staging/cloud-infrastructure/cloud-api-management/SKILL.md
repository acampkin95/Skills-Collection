...
This skill is a leaf of the [cloud-infrastructure](../cloud-infrastructure/SKILL.md) master router.
name: cloud-api-management
description: Cloud infrastructure and API management for Cloudflare (DNS/Workers), Tailscale (ACL/MagicDNS), S3 storage, GitHub automation, multi-cloud orchestration. Use when Cloudflare API, Tailscale, S3, GitHub API, multi-cloud, infrastructure as code.
---
...
- [ovhcloud-dedicated](../ovhcloud-dedicated/SKILL.md) — OVHcloud dedicated server API (sibling cloud-infra skill)
- [github-actions-ci](../github-actions-ci/SKILL.md) — CI/CD for cloud-deploy automation
