...
description: Next.js 16.0.10+ full-stack development with React 19, Tailwind CSS v4, Zustand v5, TanStack Query, Server Actions, Cache Components, and DevTools MCP. Use when cache components, useActionState, async params, hydration fixes, Auth.js v5 integration.
---
