...
description: Code quality control workflow — linting, formatting, testing integration, quality gates. Use when QA workflow, pre-commit hooks, CI quality gate, linter orchestration, coverage thresholds.
---
