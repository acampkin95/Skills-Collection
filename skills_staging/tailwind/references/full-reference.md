---
name: tailwind
description: "Use this skill when working with Tailwind, tailwind.config, @tailwind, utility classes, tw: syntax, CSS frameworks, Tailwind v4, responsive styling, utility-first CSS, @theme, @import, dark mode CSS, container queries. Tailwind CSS v4 (Oxide engine) with CSS-first configuration, native CSS variables, container queries, and 5-100x faster builds. Zero JavaScript config."
---
