...
description: Use this skill when CLI tool, command line, commander.js, clap, argparse, CLI app, terminal tool, interactive prompts, command-line interface. Expert guidance on argument parsing, interactive UIs (@clack), output formatting, config management (cosmiconfig), packaging, and distribution.
---
