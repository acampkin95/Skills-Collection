...
description: Advanced TypeScript patterns and type-safe abstractions. Use this skill when TypeScript, generics, type utility, mapped types, conditional types, infer, satisfies, branded types, phantom types. Use this skill when type guards, discriminated unions, template literal types, decorator patterns, module augmentation, recursive types, type challenges.
---
