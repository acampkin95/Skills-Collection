...
name: docker-compose
description: Docker Compose orchestration for local development and production deployment with multi-container services, healthchecks, volumes, networks, profiles. Use when docker-compose.yml, Compose v2, multi-container stack, healthcheck, depends_on, profile, swarm.
---
