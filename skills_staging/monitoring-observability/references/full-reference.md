...
description: Monitoring and observability for TypeScript applications with Pino structured logging, Sentry v9.17.0+ error tracking, OpenTelemetry (v0.135+) distributed tracing, metrics collection, health checks, and alerting strategies. Use this skill when monitoring, observability, OpenTelemetry, Sentry, logging, tracing, metrics, Prometheus, Grafana, alerting, health checks, correlation ID. Use this skill when Three pillars of observability, structured logging patterns, distributed tracing setup, and incident response.
---
