---
name: sonar-scanner
description: SonarScanner CLI setup, configuration, and execution for code quality analysis. Use when setting up SonarQube/SonarCloud scanning, generating sonar-project.properties files, running static analysis, configuring quality gates, or troubleshooting scan failures. Triggers on requests involving code quality scanning, SonarQube, SonarCloud, sonar-scanner CLI, static analysis configuration, or quality gate setup. Covers TypeScript, JavaScript, Next.js, Python, and multi-language projects.
---
