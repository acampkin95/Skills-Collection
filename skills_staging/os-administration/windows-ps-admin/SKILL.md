...
This skill is a leaf of the [os-administration](../os-administration/SKILL.md) master router.
name: windows-ps-admin
description: Windows 11 PowerShell scripting, automation, and system administration for developers and DevOps engineers. Use when Windows, PowerShell, pwsh, Get-Service, Set-ItemProperty, registry edit, scheduled task, Active Directory, Windows admin.
---
