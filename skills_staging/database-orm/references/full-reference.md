---
name: database-orm
description: PostgreSQL database design with Prisma and Drizzle ORM for TypeScript/Next.js applications. Use this skill when PostgreSQL, Prisma ORM, Drizzle ORM, database schema, database migration, N+1 queries, connection pooling, Prisma Accelerate, transaction handling, database seeding, query optimization, EXPLAIN ANALYZE, zero-downtime migration. Use this skill when designing normalized database schemas, writing and managing migrations, optimizing database queries and preventing N+1 problems, implementing connection pooling strategies, handling transactions and ACID compliance, seeding test and production data, configuring ORM caching, and executing zero-downtime deployments.
---
